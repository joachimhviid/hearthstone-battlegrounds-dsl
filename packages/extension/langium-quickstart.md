...
- Run `pnpm run langium:generate` to generate TypeScript code from the grammar definition.
...
- Run `pnpm run langium:watch` to have the Langium generator run automatically after every change of the grammar declaration.
