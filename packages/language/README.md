...
- [src/hearthstone-battlegrounds-dsl.langium](src/hearthstone-battlegrounds-dsl.langium) -  The grammar definition of your language
- [src/hearthstone-battlegrounds-dsl-module.ts](src/hearthstone-battlegrounds-dsl-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/hearthstone-battlegrounds-dsl-validator.ts](src/hearthstone-battlegrounds-dsl-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/hearthstone-battlegrounds-dsl.monarch.ts](src/syntaxes/hearthstone-battlegrounds-dsl.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/hearthstone-battlegrounds-dsl.tmLanguage.json](syntaxes/hearthstone-battlegrounds-dsl.tmLanguage.json) - Textmate based syntax highlighting instructions.
